...
enum RG_LogCategory {
	RG_LOG_GAME   = SDL_LOG_CATEGORY_APPLICATION,
	RG_LOG_ERROR  = SDL_LOG_CATEGORY_ERROR,
	RG_LOG_ASSERT = SDL_LOG_CATEGORY_ASSERT,
	RG_LOG_SYSTEM = SDL_LOG_CATEGORY_SYSTEM,
	RG_LOG_AUDIO  = SDL_LOG_CATEGORY_AUDIO,
	RG_LOG_RENDER = SDL_LOG_CATEGORY_RENDER,
	RG_LOG_DEBUG  = SDL_LOG_CATEGORY_CUSTOM,
	RG_LOG_MEMORY,
	RG_LOG_SCRIPT
};
...
#define RG_LOG_SCRIPT (SDL_LOG_CATEGORY_CUSTOM+1)
#define RG_LOG_SCRIPT (SDL_LOG_CATEGORY_CUSTOM+2)
#define RG_LOG_SCRIPT (SDL_LOG_CATEGORY_CUSTOM+3)
#define RG_LOG_SCRIPT (SDL_LOG_CATEGORY_CUSTOM+4)
#endif
